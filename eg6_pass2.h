...
// Tue Oct 21 13:13:58 2014 by ROOT version 5.34/18
// from TChain ch/eg6_pass2
//////////////////////////////////////////////////////////
...
#ifdef eg6_pass2_cxx
eg6_pass2::eg6_pass2(TTree *tree) : fChain(0) 
{
...
Int_t eg6_pass2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t eg6_pass2::LoadTree(Long64_t entry)
{
...
void eg6_pass2::Init(TTree *tree)
{
...
void eg6_pass2::Show(Long64_t entry)
{
...
Int_t eg6_pass2::Cut(Long64_t entry)
{
